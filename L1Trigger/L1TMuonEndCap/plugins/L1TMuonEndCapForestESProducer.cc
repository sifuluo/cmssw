  ...
  data_(new L1TMuonEndCapForest())
{
   ...
   //DEBUG: data = 1, 1.375, 27, 16, 4, 1, 
   {
     ...
     cout << "DEBUG: original result:  0.072506, our result:  " << data_.evaluate(15, x) << "\n";
   }
   //DEBUG: mode:  15 dir L1Trigger/L1TMuon/data/emtf_luts/ModeVariables/trees/15 num trees 64
   ...
   //DEBUG: data = 1, 1.325, 7, 0, 0, 0,    
   {
     ...
     cout << "DEBUG: original result:  0.021769, our result:  " << data_.evaluate(15, x) << "\n";
   }
   //DEBUG: mode:  11 dir L1Trigger/L1TMuon/data/emtf_luts/ModeVariables/trees/11 num trees 64
   //DEBUG: pred val:  0.0298634
   //DEBUG: data = 1, 1.725, 34, 10, 3, 0, 1, 
   {
     std::vector<double> x = {1, 1.725, 34, 10, 3, 0, 1};    
     cout << "DEBUG: original result:  0.0298634, our result:  " << data_.evaluate(11, x) << "\n";
   }
   //DEBUG: mode:  10 dir L1Trigger/L1TMuon/data/emtf_luts/ModeVariables/trees/10 num trees 64
   //DEBUG: pred val:  0.201593
   //DEBUG: data = 1, 1.725, -38, 3, 2, 0, 1, 
   {
     std::vector<double> x = {1, 1.725, -38, 3, 2, 0, 1};    
     cout << "DEBUG: original result:  0.201593, our result:  " << data_.evaluate(10, x) << "\n";
   }
}
