...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:test_reprocess_SMP-PhaseIIFall17D-00003.root'),
...
process.schedule = cms.Schedule(process.EcalEBtp_step,process.hgcl1tpg_step,process.L1simulation_step,process.endjob_step,process.FEVTDEBUGHLToutput_step)
