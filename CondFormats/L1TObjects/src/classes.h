...
//    std::vector<L1RPCConeDefinition::TRingToLP> dummy15b;
    ...
    L1TMuonEndCapParams dummy19a;
    L1TMuonEndCapParams::DTree dummy19b;
    L1TMuonEndCapParams::DForest dummy19c;
    L1TMuonEndCapParams::DForestColl dummy19d;
    L1TMuonEndCapParams::DForestMap dummy19e;
